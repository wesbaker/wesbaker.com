...
import status from "../../content/projects/prusa-raycast/prusa-1.png";
import commands from "../../content/projects/prusa-raycast/prusa-2.png";
import menubar from "../../content/projects/prusa-raycast/prusa-3.png";
...
<Figure src={status} alt="Prusa printer status">
...
`FigureGrid` places two or three `Figure` components side by side on larger
screens and stacks them on mobile:

<FigureGrid>
  <Figure src={commands} alt="Prusa extension commands">
    Two figures share a row on larger screens.
  </Figure>

  <Figure src={menubar} alt="Prusa extension menubar">
    The same figures stack on mobile.
  </Figure>
</FigureGrid>
